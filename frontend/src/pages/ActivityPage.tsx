  ...
  return (
    <div className="p-6">
      ...
      <div className="card divide-y divide-border">
        {items.length === 0 ? (
          <div className="p-8 text-center text-fg-dim">No activity yet.</div>
        ) : (
          items.map(a => (
            <div key={a.id} className="p-3">
              ...
              {a.reason && <div className="mt-1 text-xs text-fg-muted">reason: {a.reason}</div>}
              {(a.before || a.after) && (
                <details className="mt-1">
                  <summary className="cursor-pointer text-xs text-fg-dim">diff</summary>
